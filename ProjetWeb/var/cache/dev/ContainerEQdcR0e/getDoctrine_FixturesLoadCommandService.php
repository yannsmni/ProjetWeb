...
include_once $this->targetDirs[3].'\\src\\DataFixtures\\EvenementFixtures.php';
include_once $this->targetDirs[3].'\\src\\DataFixtures\\ProduitFixtures.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\EvenementFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ProduitFixtures(), 'groups' => []]]);
