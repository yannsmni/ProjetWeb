...
/* shop.html.twig */
class __TwigTemplate_ef13d9d9ae2336b45e0f5ee92a5743726219802633b43f0a62fa4a6b60685eff extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<body>
  ...
  <div class=\"d-flex\" id=\"wrapper\">
    ...
    <div class=\"border-right\" id=\"sidebar-wrapper\" style=\"background-color: black;\">
      <div class=\"sidebar-heading text-white text-center font-weight-bold text-white\">Produits</div>
      <div class=\"list-group list-group-flush\">
        <a href=\"";
        // line 30
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("boutique");
        echo "\" class=\"list-group-item list-group-item-action text-white\" style=\"background-color: black;\">T-Shirt</a>
        <a href=\"";
        // line 31
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("boutique");
        echo "\" class=\"list-group-item list-group-item-action text-white\" style=\"background-color: black;\">Pulls</a>
        <a href=\"";
        // line 32
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("boutique");
        echo "\" class=\"list-group-item list-group-item-action text-white\" style=\"background-color: black;\">Goodies</a>
        <a href=\"";
        // line 33
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("boutique");
        echo "\" class=\"list-group-item list-group-item-action text-white\" style=\"background-color: black;\">Autres</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
    ...
    <div id=\"page-content-wrapper\">
      ...
      <nav class=\"navbar navbar-expand-lg navbar-dark border-bottom\" style=\"background-color: black;\">
        ...
        <button class=\"btn btn-secondary mr-4\" id=\"menu-toggle\">Produits</button>
        ...
        // line 58
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("boutique");
        echo "\">Boutique <span class=\"sr-only\">(current)</span></a>
                    </li>
                    <li class=\"nav-item\">
                        <a class=\"nav-link h5\" href=\"";
        // line 61
...
<body>
  ...
  <div class=\"d-flex\" id=\"wrapper\">
    ...
    <div class=\"border-right\" id=\"sidebar-wrapper\" style=\"background-color: black;\">
      <div class=\"sidebar-heading text-white text-center font-weight-bold text-white\">Produits</div>
      <div class=\"list-group list-group-flush\">
        <a href=\"{{ path('boutique') }}\" class=\"list-group-item list-group-item-action text-white\" style=\"background-color: black;\">T-Shirt</a>
        <a href=\"{{ path('boutique') }}\" class=\"list-group-item list-group-item-action text-white\" style=\"background-color: black;\">Pulls</a>
        <a href=\"{{ path('boutique') }}\" class=\"list-group-item list-group-item-action text-white\" style=\"background-color: black;\">Goodies</a>
        <a href=\"{{ path('boutique') }}\" class=\"list-group-item list-group-item-action text-white\" style=\"background-color: black;\">Autres</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
      ...
      <nav class=\"navbar navbar-expand-lg navbar-dark border-bottom\" style=\"background-color: black;\">
        ...
        <div class=\"collapse navbar-collapse ml-4\" id=\"navbarSupportedContent\">
                <ul class=\"navbar-nav mr-auto\">
                    ...
                    <li class=\"nav-item active\">
                        <a class=\"nav-link h5\" href=\"{{ path('boutique') }}\">Boutique <span class=\"sr-only\">(current)</span></a>
                    </li>
                    <li class=\"nav-item\">
...
", "shop.html.twig", "C:\\Users\\Clément\\Documents\\CESI\\3eme_semestre\\BLOC_2\\ProjetWebBDE\\ProjetWeb\\ProjetWeb\\templates\\shop.html.twig");
    }
}
