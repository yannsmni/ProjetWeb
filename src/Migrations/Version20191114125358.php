 ...
 */
final class Version20191114125358 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, evenement_id INT NOT NULL, utilisateur_id INT NOT NULL, filename VARCHAR(255), description VARCHAR(255) NOT NULL, visible TINYINT(1) NOT NULL, date_edit DATETIME NOT NULL, INDEX IDX_C53D045FFD02F13 (evenement_id), INDEX IDX_C53D045FFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
