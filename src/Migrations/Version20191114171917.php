...
final class Version20191114171917 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE evenement_utilisateur (evenement_id INT NOT NULL, participant VARCHAR(255) NOT NULL, INDEX IDX_8C897598FD02F13 (evenement_id), PRIMARY KEY(evenement_id, participant)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
